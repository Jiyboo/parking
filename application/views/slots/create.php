              ...
              <div class="box-body">
               ...
               <div class="form-group">
                ...
                <select class="form-control" id="availability_status" name="availability_status">
                  <option value="1" <?= (isset($slot_data['availability_status']) && $slot_data['availability_status'] == 1) ? 'selected' : '' ?>>Available</option>
                  <option value="2" <?= (isset($slot_data['availability_status']) && $slot_data['availability_status'] == 2) ? 'selected' : '' ?>>Not Available</option>
                </select>
              </div>    
            </div>
              <!-- /.box-body -->
